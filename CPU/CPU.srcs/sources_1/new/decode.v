...
module decode(
    ...
    wire Function_opcode = instr[5:0];
    wire R_format, Lw, Sw;
    ...
    wire imm_extended = (6'b001100 == opcode || 6'b001101 == opcode)?{{16{1'b0}},immediate}:{{16{Instruction[15]}},immediate};
    assign imm = (ALUSrc == 1'b1) ? imm_extended : {{16{1'b0}},immediate};
